...
39: { fullName: "ড্রিপ সেচ প্রচার প্রকল্প", amount: "৬০-৮০% ভর্তুকি", benefits: ["ড্রিপ সেচ ব্যবস্থা", "৬০% পর্যন্ত জল সাশ্রয়", "উচ্চ ফলন", "ফার্টিগেশন উপযোগী"], eligibility: ["সকল কৃষক", "উদ্যানপালন কৃষকদের অগ্রাধিকার", "এফপিও"], documents: ["জমির রেকর্ড", "ফসলের বিবরণ", "আধার", "ব্যাংক অ্যাকাউন্ট"] },
...
70: { fullName: "জৈব-কীটনাশক প্রচার প্রকল্প", amount: "একর প্রতি ₹২,০০০ পর্যন্ত ৫০% ভর্তুকি", benefits: ["নিমভিত্তিক কীটনাশক", "ট্রাইকোডার্মা সরবরাহ", "সিউডোমোনাস কালচার", "আইপিএম প্রশিক্ষণ"], eligibility: ["সকল কৃষক", "জৈব কৃষক", "এফপিও"], documents: ["জমির রেকর্ড", "আধার", "ব্যাংক অ্যাকাউন্ট"] },
...
116: { fullName: "ঘূর্ণিঝড় ত্রাণ প্রকল্প", amount: "₹২২,০০০/হেক্টর", benefits: ["ঘূর্ণিঝড় ক্ষতির ক্ষতিপূরণ", "বাগানের ক্ষতি কভারেজ", "গবাদি পশুর ক্ষতির সহায়তা", "ইনপুট ভর্তুকি"], eligibility: ["উপকূলীয় এলাকার কৃষক", "ঘূর্ণিঝড় আক্রান্ত অঞ্চল"], documents: ["জমির রেকর্ড", "ঘূর্ণিঝড় ক্ষতির প্রতিবেদন", "আধার", "ব্যাংক অ্যাকাউন্ট"] },
